...
class AttendantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendant" do
    assert_difference('Attendant.count') do
      post attendants_url, params: { attendant: { annotations: @attendant.annotations, email: @attendant.email, interest: @attendant.interest, name: @attendant.name, occupation: @attendant.occupation, phone: @attendant.phone } }
    end
  ...
  test "should update attendant" do
    patch attendant_url(@attendant), params: { attendant: { annotations: @attendant.annotations, email: @attendant.email, interest: @attendant.interest, name: @attendant.name, occupation: @attendant.occupation, phone: @attendant.phone } }
